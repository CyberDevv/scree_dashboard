  ...
  const [collections, setCollections] = useState([
    {
      id: 1,
      image:
        "https://images.pexels.com/photos/5081399/pexels-photo-5081399.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
      name: "Sofa",
    },
    {
      id: 2,
      image:
        "https://images.pexels.com/photos/698170/pexels-photo-698170.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
      name: "Collection 1",
    },
    {
      id: 3,
      image:
        "https://images.pexels.com/photos/4048419/pexels-photo-4048419.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
      name: "collection 2",
    },
    {
      id: 4,
        ...
        {collections.map(({ id, image, name }) => {
          return (
            <div key={id}>
              ...
              <CollectionName className="smallBold">{name}</CollectionName>
            </div>
          );
        })}
      </CollectionWrapper>
